def evaluate(ast, environment):
    ...
    if ast["tag"] == "repeat_until":
        while True:
            block, _ = evaluate(ast["block"], environment)  
...
# Modulus test
def test_evaluate_modulus_operators():
    print("test evaluare modulus operators")
    equals("8 % 3", {}, 2)
    equals("-8 % 3", {}, 1)
    equals("8.5 % 3", {}, 2.5)
    
# Repeat until test
def test_evaluate_repeat_until():
    print("test evaluate repeat until")
    equals("repeat { x = x + 1; } until (x >= 10)", {"x": 0} , None, {"x": 10})
...
if __name__ == "__main__":
    ...
    test_evaluate_modulus_operators()
    test_evaluate_repeat_until()
